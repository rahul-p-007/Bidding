...
<div id="main_content">
  ...
  $query = mysqli_query($connection, "SELECT * FROM member WHERE memberid = '$userid'") or die(mysqli_error($connection));
  ...
  <div class="center_content">
          ...
          <div class="specifications">
            <div class='hidemsg'>
              <div class="thumbs">
                ...
                <div class="thumbs">
                  Message: <span class="blue">
                    <p align='justify'><br />&nbsp&nbsp&nbsp&nbsp&nbsp Lorem ipsum dolor sit amet.ipsum dolor sit
                      ametipsum dolor sit ametipsum dolor sit ametipsum dolor sit ametipsum dolor sit ametipsum dolor
                      sit ametipsum dolor sit ametipsum dolor sit ametipsum dolor sit ametipsum dolor sit ametipsum
                      dolor sit ametipsum dolor sit ametipsum dolor sit ametipsum dolor sit amet</p>
                  </span><br />
                  Last: <span class="blue">September 8, 2011</span>
                </div>
                <div class="thumbs">
                  <span class="blue">
                    <p align='right'><a>Reply</a></p>
                  </span>
                </div>
              </div>
            </div>
            <div class='hidenotif'>
              <div class="thumbs">
                ...
                <?php
                $get = mysqli_query($connection, "SELECT * FROM needtopay WHERE needtopay.memberid = '$userid' AND needtopay.status=0") or die(mysqli_error($connection));
                $getit = mysqli_fetch_array($get);
                $prod = $getit['productid'];
                $getprod = mysqli_query($connection, "SELECT * FROM products WHERE productid = '$prod'") or die(mysqli_error($connection));
                $fetchit = mysqli_fetch_array($getprod);
                ?>

                <div class="thumbs">
                  <span>
                    <p align='justify'>Congratulations!!<br />You are the winner of item on bid named
                    ...
                    <div class="thumbs">
                      ...
                      <input type='submit' name='pay' value='PAY' /><input type='submit' name='decline'
                        value='DECLINE' />
                    </div>
                  </span>
                  <hr />
    ...
    <div class="prod_box">
      ...
      <div class="center_prod_box">
        <div class="product_img"><a href="details.html"><img src="images/Mail[1].png" width="120" height="90" alt=""
              border="0" /></a></div>
    ...
    <div class="prod_box">
      <div class="top_prod_box"></div>
      <div class="center_prod_box">
        <div class="product_img"><a href="watchthis.php" rel='facebox'><img src="images/p5.gif" alt="" border="0" /></a>
        </div>
