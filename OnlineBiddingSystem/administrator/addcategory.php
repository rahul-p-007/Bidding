		...
		<div id="bgwrap">
			<div id="primary_left">
				<div id="menu"> <!-- navigation menu -->
					<ul>
						<li><a href="notifications.php"><img src="icons/73.png" alt /><span>Notifications</span></a>
						</li>
						...
						<div id="bodycon">
							<form method="post" name="prodform" id="prodform" action="" enctype='multipart/form-data'>
								<div id="textcon">
									...
									<input name="cmdcancel" type="submit" id="cmdcancel" value="Cancel"
										class="namewidth" />
								</div>&nbsp;
								<div id="inputcon1">
									...
									<table width="554" border="0">
										...
										<?php
										$result = $con->query("SELECT * FROM pcategories ORDER BY categoryid");
										...
										if ($numberOfRows == 0) {
											...
											while ($i < $numberOfRows) {
												...
												$this_CategoryID = null;
												$this_CategoryName = null;
												$image = null;
												...
												?>
													...
													<tr>
														...
														<td>
														<?php echo $this_CategoryName; ?>
														</td>
														<td><img src="images/category/<?php echo $image; ?>" width="100px"
																height="100px" /></td>
														<td><a href="edit.category.php?CategoryID=<?php echo $this_CategoryID; ?>"><img
																	src="backgrounds/contact_grey_edit.png" alt="" width="20"
																	height="20" /></a></td>

														<td><a
																href="delete_category.php?CategoryID=<?php echo $this_CategoryID; ?>"><img
																	src="backgrounds/contact_grey_remove.png" alt="delete record"
																	onClick="return confirm('Are you sure you want to delete <?php echo $this_CategoryID; ?>');"
