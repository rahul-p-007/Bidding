...
{
	global $con;
	$query = $con->query("SELECT * FROM `pcategories`") or die($con->error);
...
if (isset($_POST['prodsave'])) {
	...
	$query = $con->prepare("INSERT INTO products (prodname, categoryid, prodescription, startingbid, prodimage, regularprice, dateposted, duedate, status) 
							VALUES (?, ?, ?, ?, ?, ?, NOW(), ?, 0)");
	$query->bind_param("sissdss", $prodname, $category, $descrpt, $startingbid, $name, $regularprice, $duedate);
	$query->execute();
			...
			<div id="primary_left">
				<div id="menu"> <!-- navigation menu -->
					<ul>
						...
						<li><a href="#"><img src="./assets/icons/small_icons_3/settings.png"
