		...
		<div id="bgwrap">
			<div id="primary_left">
				...
				<div id="menu"> <!-- navigation menu -->
					<ul>
						<li class="current"><a href="notif.php"><img src="icons/73.png"
			...
			<div id="primary_right">
				...
				<div class="inner">
					...
					$endedsum = mysqli_query($con, "SELECT * FROM products WHERE status = 1") or die(mysqli_error($con));
					$counters = 0;
					...
					<!--for notifications-->
					<ul>
						<div id="number"><img src="./assets/icons/notif.png" alt="0" width='94'
								height='92' /><br />Notifications<div id="num_result">
								<?php echo $count; ?>
							</div>
						</div>
					</ul>
					...
					<!--for messages-->
					<ul>
						<div id="wew"><img src="./assets/icons/notif.png" alt="0" width='94'
								height='92' /><br />Messages<div id="msg_result">
								<?php echo $counter; ?>
							</div>
						</div>
						<div class="nota">
					...
					<!--for notifications-->
					<ul>
						<div id="numberee"><img src="./assets/icons/notif.png" alt="0" width='94'
								height='92' /><br />Ended Products<div id="end_result">
								<?php echo $counters; ?>
							</div>
						</div>
					</ul>
					...
					while ($stat = mysql_fetch_array($bids_stat)) {
						...
						<div class="notif id<?php echo $stat['bidid']; ?>" id="<?php echo $stat['bidid']; ?>">
							<p>
								<span>
									<?php echo $stat['lastname'] . ", " . $stat['firstname']; ?>
								</span>
								Has Placed <strong>Php
									<?php echo $stat['bidamount']; ?>
								</strong> On
								<?php echo $stat['prodname']; ?> last <strong>
									<?php echo $stat['biddatetime']; ?>
								</strong>
							</p>
						</div>
					<?php } ?>
