		...
		<div id="bodycon">
			<table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="700">
				...
				<tbody>
					<?php
					$prodid = $_GET['id'];
					$query = $con->query("SELECT * FROM bidreport LEFT JOIN member ON member.memberid = bidreport.bidder LEFT JOIN products ON products.productid = bidreport.productid WHERE products.productid = '$prodid'") or die($con->error);
