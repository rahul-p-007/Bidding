	...
	<div class="center_content">
		...
		<div class="mandms">
			...
			<div class="prod_box_big">
				...
				<div class="center_prod_box_big">
					<div class="welc">
						<center>Welcome to the Bidding Zone</center>
					</div>
					<div class="welcsub">
						<center>
							<p>Welcome, your account is not yet completely activated. You are required to complete this
								steps in order to participate in bidding activities on this site.
							<p>
						</center>
					</div>
					<div class='logreg'>
					...
					<div class="contact_form">
						<div id="form_row1a">
							<span class="blue">&nbsp; &nbsp; The Bidding Zone purpose is to give and provide excelled
								services, creating an appropriate online auction webpage that promotes different kinds
								of products. It declares the company�s purpose and serves as the standard against in
								which the business weighs its actions and decisions.</span>
						</div>
					</div>
					...
					<div class="reg_form">
						<div id="regstep1">
							<span class="blue">
								<li>To provide fast and easy online bidding transactions to customers with a user
									friendly online system.</li>
								<li>To provide the company a faster way to advertise and to communicate with its
									customer with regards of bidding transactions and product.</li>
		...
		<div class="organization">
			...
			<div class="prod_box_big">
				...
				<div class="center_prod_box_big">
					<div class="welc">
						<center>Company's Organizational Chart</center>
					</div>
					<div class='logreg'>
						<div class="loginb">
							<div class="top_prod_box"></div>
		...
		<div class="companyfeedback">
			...
			<div class="prod_box_big">
				...
				<div class="center_prod_box_big">
					...
					<div class="welcsub">
						<center>
							<p>Welcome to Bidding Zone User Agreement. This agreement describes the terms and conditions
								applicable to your use of our services. By clicking the "I Accept" button, you accept
								ther terms and
					...
					<div class='companyfeedback'>
						<div class="loginc">
							...
							<span class="blue">
								<li>Our services are available only to individuals who can form legally binding contract
									without limiting
									the foregoing, our services are not available to minor. if you do not qualify,
									please do not use our services.</li>
							</span><br>
							<div class="welcsub"><b>Fees</b></div>
							<span class="blue">
								<li>Joining Bidding Zone cost P150 for the membership. Our then current Fees and Credit
									Policies for selling
									item are available at Bidding Zone. Unless otherwise stated, all fees are quoted in
									Philippines Peso. You are responsible for paying
									all applicable taxes and for all hardware, software, services and other costs you
									incur to bid, buy.</li>
							</span><br>
							<div class="welcsub"><b>Bidding and Buying</b></div>
							<span class="blue">
								<li>As a bidder, if you have the highest bid at the end of the auction, at or above the
									minimum bid price
		...
		<div class="developer">
			...
			<div class="prod_box_big">
				...
				<div class="center_prod_box_big">
					...
					<div class="welcsub">
						<center>
							<p>the following students are rated PG.. :)
							<p>
						</center>
					</div>
					<div class='logreg'>
					...
					<div class='developer'>
						<div class="loginc">
							<br><br>
							<span class="blue">Rahul Prasad</span>
							<br><br><br>
							<span class="blue">Tonmoy</span>
							<br><br><br>
							<span class="blue">Anurag</span>
							<br><br><br>
							<span class="blue">Akash</span>
							<br><br><br>
							<span class="blue">Narayan</span>
						</div>
					</div>
				</div>
				<div class="bottom_prod_box_big"></div>
