...
<body>
	<div id="container">
		...
		$pnamea = $result->fetch_assoc();

		if (!$pnamea) {
			die("Error: Product not found.");
		}

		// Use the retrieved product information as needed
		
		$stmt->close();
		?>
		<center>
			<h5>
				<?php echo $pnamea['prodname']; ?> Bidding Log
			</h5>
		</center>
		<div id="bodycon">
          ...
          LEFT JOIN member ON member.memberid = bidreport.bidder 
          LEFT JOIN products ON products.productid = bidreport.productid 
